...
{
	case "C_Offroad_01_F": {_weight = 75;};
	case "B_G_Offroad_01_F": {_weight = 75;};
	case "B_Quadbike_01_F": {_weight = 25;};
	case "I_Truck_02_covered_F": {_weight = 300;};
	case "I_Truck_02_transport_F": {_weight = 250;};
	case "C_Hatchback_01_F": {_weight = 50;};
	case "C_Hatchback_01_sport_F": {_weight = 55;};
	case "B_Heli_Attack_01_F": {_weight = 80;};
	case "B_Heli_Light_01_armed_F": {_weight = 80;};
	case "B_Plane_CAS_01_F": {_weight = 80;};
	case "C_SUV_01_F": {_weight = 60;};
	case "C_Van_01_transport_F": {_weight = 150;};
	case "I_G_Van_01_transport_F": {_weight = 150;};
	case "C_Van_01_box_F": {_weight = 200;};
	case "C_Boat_Civil_01_F": {_weight = 85;};
	case "C_Boat_Civil_01_police_F": {_weight = 85;};
	case "C_Boat_Civil_01_rescue_F": {_weight = 85;};
	case "B_Truck_01_box_F": {_weight = 600;};
	...
	case "I_Heli_Transport_02_F": {_weight = 500;};
	case "B_Heli_Transport_01_F": {_weight = 400;};
	case "B_Heli_Transport_01_camo_F": {_weight = 400;};
