...
switch (playerSide) do
{
	...
	case west:
	{
		...
		//Unrest Action
		_persActions = _persActions + [player addAction["Unrestrain",life_fnc_unrestrain,cursorTarget,0,false,false,"",
	...
	case civilian:
	{
		...
		' !isNull cursorTarget && cursorTarget isKindOf "Man" && (isPlayer cursorTarget) && animationState cursorTarget == "AmovPercMstpSnonWnonDnon_Ease" && (side cursorTarget == civilian) && player distance cursorTarget < 3.5 && (cursorTarget getVariable "Escorting")']];
		_persActions = _persActions + [player addAction["Entfesseln",life_fnc_unrestrain,cursorTarget,0,false,false,"",
