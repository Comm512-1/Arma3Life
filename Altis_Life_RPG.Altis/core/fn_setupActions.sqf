...
switch (playerSide) do
{
	...
	case civilian:
	{
		...
		!isNull cursorTarget && cursorTarget getVariable ["playerSurrender",false] && (currentWeapon player != "") && cursorTarget isKindOf "Man" && (isPlayer cursorTarget) && alive cursorTarget && cursorTarget distance player < 5 && !(cursorTarget getVariable ["Escorting",false]) && speed cursorTarget < 1 ']];
