...
if(!((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship") || (_vehicle isKindOf "Tank") || (_vehicle isKindOf "Support"))) exitWith {};
...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship") || (_vehicle isKindOf "Tank") || (_vehicle isKindOf "Support")) then
{
	...
	{
		if(!((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship") || (_vehicle isKindOf "Tank") || (_vehicle isKindOf "Support"))) exitWith {life_action_inUse = false;};
		...
		switch (true) do
		{
			...
			case (_vehicle isKindOf "Tank"): {_price = (call life_impound_armored);};
			case (_vehicle isKindOf "Support"): {_price = (call life_impound_support);};
		};
